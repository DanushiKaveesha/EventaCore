                    ...
                    <div className="space-y-10">
                        ...
                        <div className="pt-6 border-t border-slate-100">
                            <button
                                ...
                                className={`w-full group relative inline-flex items-center justify-center px-8 py-5 text-sm font-black text-white uppercase tracking-widest transition-all duration-300 rounded-2xl overflow-hidden ${submitStatus?.type === 'success' ? 'bg-emerald-500' : 'bg-slate-900 hover:bg-blue-600 hover:shadow-xl hover:shadow-blue-600/20 hover:-translate-y-1'
                                    }`}
                            >
