                    ...
                    {featuredEvents.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {featuredEvents.map(event => (
                                <Link to={`/events/${event._id}`} key={event._id} className="group flex flex-col bg-white rounded-3xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
