...
import { getAllMemberships, updateMembershipRequest } from '../services/membershipService';
import {
...
const AdminRequests = () => {
    ...
    if (error) return (
        <div className="flex-1 p-8 text-center">
            <div className="inline-block p-8 bg-red-50 border border-red-100 rounded-2xl">
                <h3 className="text-xl font-bold text-red-600 mb-2">Failed to load memberships</h3>
    ...
    return (
        <div className="flex-1 w-full py-8 px-4 sm:px-6 lg:px-8 bg-slate-50/30 relative">
                {/* Confirmation Modal */}
                {confirmModal.show && (
