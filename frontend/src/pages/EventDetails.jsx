                    ...
                    {user ? (
                      ...
                      <div className="text-center">
                        ...
                        <button
                          ...
                          className="w-full py-5 bg-gradient-to-r from-slate-700 to-slate-900 text-white font-black text-xl rounded-2xl shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all"
                        >
                          Login to Book
                        </button>
                      </div>
